						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-md-6">
								<div class="txt-block left-column color--white wow fadeInRight">
									...
									<!-- Text -->	
									<p class="p-lg w-400">Sodales tempor sapien quaerat ipsum congue undo laoreet turpis 
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 order-last order-md-2">
							<div class="txt-block left-column wow fadeInRight">
								...
								<!-- Text -->	
								<p class="p-lg mb-0">&quot;Sodales tempor sapien diam purus ipsum quaerat and volute 
